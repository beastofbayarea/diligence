...
$groups = [ordered]@{
    ...
    '3. APPLICATION, BACKEND, DATABASE & AUTH' = '^(SUPABASE_|POSTGRES_|JWT_|NEXT_PUBLIC_API_URL$|SERVER_PORT$|SPRING_PROFILES_ACTIVE$|GENERATE_SOURCEMAP$|JOB_APP_DASHBOARD_)'
    '4. GOOGLE CLOUD, VERTEX AI & GOOGLE OAUTH' = '^(GCP_|GOOGLE_CLOUD_|GOOGLE_APPLICATION_|GOOGLE_GENAI_|GOOGLE_WORKSPACE_|GOOGLE_OAUTH_|GOOGLE_INSTALLED_|GOOGLE_SA_|VERTEX_|GEMINI_|SAMSUNG_GALAXY_|NEXT_PUBLIC_GOOGLE_|OAUTH_|WEB_)'
    ...
    '8. SOURCE CONTROL, CMS, MEDIA & META' = '^(GITHUB_|GH_TOKEN$|PUBLIC_CONTENTFUL_|CONTENTFUL_|PEXELS_|META_)'
